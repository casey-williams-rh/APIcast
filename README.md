...
This is a fork repository from [https://github.com/3scale/APIcast](https://github.com/3scale/APIcast) initially created to meet the need to use a ubi8-minimal based image requested by the FedRAMP project and because it is a smaller image, we will have less packages to maintain and in turn fewer CVEs. 
